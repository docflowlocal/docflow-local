...
const live = {
  en: {
    9: 'https://buy.stripe.com/example-9',
    29: 'https://checkout.stripe.com/example-29',
    99: 'https://docflowlocal.lemonsqueezy.com/buy/example-99'
  },
  zh: {
    69: 'https://checkout.paddle.com/example-69',
    199: 'https://pay.paddle.io/example-199',
    699: 'https://docflowlocal.lemonsqueezy.com/buy/example-699'
  }
};
